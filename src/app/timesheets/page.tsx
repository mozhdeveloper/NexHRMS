...
import type { Timesheet, AttendanceRuleSet } from "@/types";

export default function TimesheetsPage() {
    const { timesheets, ruleSets, computeTimesheet, submitTimesheet, approveTimesheet, rejectTimesheet, getByEmployee, getPendingApproval, addRuleSet, updateRuleSet } = useTimesheetStore();
