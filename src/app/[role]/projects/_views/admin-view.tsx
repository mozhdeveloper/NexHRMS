...
import { FolderKanban, Plus, MapPin, UserPlus, Trash2 } from "lucide-react";
...
export default function AdminProjectsView() {
    ...
    const handleAddProject = () => {
        ...
        addProject({ name, description, location: { lat: Number(lat), lng: Number(lng), radius: Number(radius) || 100 }, assignedEmployeeIds: [] });
                    ...
                    <DialogContent className="max-w-2xl max-h-[90vh] overflow-y-auto">
                        ...
                        <div className="space-y-4 pt-2">
                            ...
                            <div>
                                ...
                                <MapSelector lat={lat} lng={lng} radius={radius} onLatChange={setLat} onLngChange={setLng} onRadiusChange={setRadius} />
                            </div>
                ...
                <DialogContent className="max-w-lg">
                    ...
                    <div className="space-y-3 max-h-[400px] overflow-y-auto pr-1 pt-2">
                        {employees.filter((e) => e.status === "active").map((emp) => (
                            <div key={emp.id} className="flex items-center gap-3 p-2.5 rounded-lg border border-border/50 hover:bg-muted/50 cursor-pointer transition-colors" onClick={() => toggleEmpSelection(emp.id)}>
